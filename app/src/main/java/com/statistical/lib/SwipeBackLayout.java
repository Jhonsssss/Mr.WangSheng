...
import com.statistical.lib.app.SwipeBackListenerActivityAdapter;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        Log.e("edgeSize","edgeSize==="+edgeSize);
        if (edgeSize > 0)
     ...
     * callback's
     * {@linkViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@linkViewDragHelper.Callback#onEdgeDragStarted(int, int)}
