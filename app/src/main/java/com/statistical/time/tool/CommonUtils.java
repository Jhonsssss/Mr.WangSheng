...
//    public static float getLocalFTPVersion() {
//        String ftpVersionStr = (String) SharedPreferencesUtils.getParam(UiUtil.getContext(),
//                UavConstants.LOCAL_FIRMWARE_VERSION, "1.00");
//        return Float.parseFloat(ftpVersionStr);
//    }

    public static long getLocalOTAVersion() {
        SharedPreferences sPOTAVersion = MyApplication.getInstance().getContext().getSharedPreferences(
                "SysLinuxVersion", Context.MODE_PRIVATE);
        return sPOTAVersion.getLong("UavLinuxVersionLocal", 0);
    }
    ...
    public static void installApk(Context context,File apkFile) {
       /* Intent installApkIntent = new Intent();
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(context, "com.highgreat.space.fileprovider", apkFile);
