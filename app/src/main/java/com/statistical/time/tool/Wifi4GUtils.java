...
public class Wifi4GUtils {
  public static final String UAV_HOST_HTTP = "http://192.168.1.1";
  /**
...
//            Log.e("---+++", "|||networkChange |||_info:" + _info.getDetailedState().toString());
...
//            Log.e("---+++", "|||isNeedChangeCellular = " + isNeedChangeCellular);
      final NetworkRequest.Builder networkReq = new NetworkRequest.Builder()
        .addCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET);
...
//    Log.e("切4g判断:","wifi  当前手机 brand:" + brand + "|||model: " + model);
