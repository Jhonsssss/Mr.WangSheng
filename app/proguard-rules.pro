...
#-renamesourcefileattribute SourceFile
 ...
 -keep class org.greenrobot.greendao.**{*;}
  ...
  -keep class com.statistical.time.fragment.** { *;}
  -keep class com.statistical.time.activity.** { *;}

  -keep class com.zero.sdk.ffmpeg.**{ *; }
  -keep interface com.statistical.greendao.** { *; }
  -keep class com.statistical.time.bean.** { *;}
  ...
  -keep public class com.statistical.time.R$*{
